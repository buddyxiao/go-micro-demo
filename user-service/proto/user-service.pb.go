...
func (x *UserRegistryResponse) Reset() {
	*x = UserRegistryResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserRegistryResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserRegistryResponse) ProtoMessage() {}

func (x *UserRegistryResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_user_service_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserRegistryResponse.ProtoReflect.Descriptor instead.
func (*UserRegistryResponse) Descriptor() ([]byte, []int) {
	return file_proto_user_service_proto_rawDescGZIP(), []int{1}
}

func (x *UserRegistryResponse) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
var file_proto_user_service_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x63, 0x0a, 0x13, 0x55, 0x73, 0x65, 0x72, 0x52,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x28, 0x0a, 0x14,
	...
	0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x4a, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x6f,
	...
	0x72, 0x64, 0x22, 0x3b, 0x0a, 0x11, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52,
	...
	0x4f, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x20, 0x2e, 0x75, 0x73,
	...
	0x12, 0x46, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x1d, 0x2e, 0x75, 0x73, 0x65, 0x72,
	...
	0x6f, 0x74, 0x6f, 0x3b, 0x75, 0x73, 0x65, 0x72, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x62,
...
var file_proto_user_service_proto_goTypes = []interface{}{
	(*UserRegistryRequest)(nil),  // 0: userservice.UserRegistryRequest
	(*UserRegistryResponse)(nil), // 1: userservice.UserRegistryResponse
	(*UserLoginRequest)(nil),     // 2: userservice.UserLoginRequest
	(*UserLoginResponse)(nil),    // 3: userservice.UserLoginResponse
}
var file_proto_user_service_proto_depIdxs = []int32{
	0, // 0: userservice.UserService.Register:input_type -> userservice.UserRegistryRequest
	2, // 1: userservice.UserService.Login:input_type -> userservice.UserLoginRequest
	1, // 2: userservice.UserService.Register:output_type -> userservice.UserRegistryResponse
	3, // 3: userservice.UserService.Login:output_type -> userservice.UserLoginResponse
...
func file_proto_user_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_user_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserRegistryResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
